...
<body class="g-sidenav-show bg-gray-100">
  ...
  <?php include('navs/sidenav-profile-kbks.php') ?>
  ...
  $(document).ready(function() {
    tabelDataBidang = $('#tabelDataBidang').DataTable({
      "ajax": {
        // json datasource
        url: "<?= base_url(); ?>/DataBidang/dataDataBidangSpec/KELUARGA BERENCANA DAN KELUARGA SEJAHTERA",
  ...
  $(document).ready(function() {
    $.ajax({
      method: "POST",
      url: "<?= base_url(); ?>/BidangKBKS/dataChartBar",
      data: {
        id: bidang
      },
      dataType: "json"
  ...
  $(document).ready(function() {
    $.ajax({
      method: "POST",
      url: "<?= base_url(); ?>/BidangKBKS/dataBidang",
      data: {
        id: bidang
      },
      dataType: "json"
  ...
  $(document).ready(function() {
    $.ajax({
      method: "POST",
      url: "<?= base_url(); ?>/BidangKBKS/dataAnggaran",
      data: {
        id: bidang,
        tahun: year,
        triwulan: quarterly
  ...
  $(document).ready(function() {
    dataPegawaiBidang = $('#tabel_dataPegawaiBidang').DataTable({
      "ajax": {
        // json datasource
        type: "POST", // method  , by default get
        url: "<?= base_url(); ?>/BidangKBKS/dataPegawaiBidang",
        data: {
          id: bidang
        },
        error: function() { // error handling
  ...
  $(document).ready(function() {
    ...
    dataPegawaiBidang = $('#tabel_dataIndikatorBidang').DataTable({
      "ajax": {
        // json datasource
        type: "POST", // method  , by default get
        url: "<?= base_url(); ?>/BidangKBKS/dataIndikatorBidang",
        data: {
          id: bidang
        },
        error: function() { // error handling
