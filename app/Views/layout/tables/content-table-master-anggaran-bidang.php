                    ...
                    <div class="card-body">
                      <form id="simpan_anggaranBidang">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" min="0" name="pagu_bidang" id="pagu_bidang" class="form-control"
                        ...
                        <div class="mb-3">
                          ...
                          <input value="0" type="number" min="0" name="realisasi_tw1" id="realisasi_tw1"
                        ...
                        <div class="mb-3">
                          ...
                          <input value="0" type="number" min="0" name="realisasi_tw2" id="realisasi_tw2"
                        ...
                        <div class="mb-3">
                          ...
                          <input value="0" type="number" min="0" name="realisasi_tw3" id="realisasi_tw3"
                        ...
                        <div class="mb-3">
                          ...
                          <input value="0" type="number" min="0" name="realisasi_tw4" id="realisasi_tw4"
                    ...
                    <div class="card-body">
                      <form id="ubah_anggaranBidang">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" min="0" name="pagu_bidang" id="ubah_pagu_bidang" class="form-control"
                            placeholder="Pagu Anggaran" aria-label="pagu">
                        </div>
                        <div class="mb-3">
                          <Label>
