                    ...
                    <div class="card-body">
                      <form id="simpan_anggaranBidang">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" min="0" name="pagu_bidang" id="pagu_bidang" class="form-control" placeholder="Pagu Anggaran" aria-label="pagu">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 1
                          </Label>
                          <input value="0" type="number" min="0" name="realisasi_tw1" id="realisasi_tw1" class="form-control" placeholder="Realisasi Triwulan 1" aria-label="realisasi-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 2
                          </Label>
                          <input value="0" type="number" min="0" name="realisasi_tw2" id="realisasi_tw2" class="form-control" placeholder="Realisasi Triwulan 2" aria-label="realisasi-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 3
                          </Label>
                          <input value="0" type="number" min="0" name="realisasi_tw3" id="realisasi_tw3" class="form-control" placeholder="Realisasi Triwulan 3" aria-label="realisasi-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 4
                          </Label>
                          <input value="0" type="number" min="0" name="realisasi_tw4" id="realisasi_tw4" class="form-control" placeholder="Realisasi Triwulan 4" aria-label="realisasi-triwulan">
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="card-body">
                      <form id="ubah_anggaranBidang">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" min="0" name="pagu_bidang" id="ubah_pagu_bidang" class="form-control" placeholder="Pagu Anggaran" aria-label="pagu">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 1
