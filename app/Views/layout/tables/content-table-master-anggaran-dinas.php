                    ...
                    <div class="card-body">
                      <form id="simpan_anggaranDinas">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" min="0" name="pagu_dinas" id="pagu_dinas" class="form-control"
                        ...
                        <div class="mb-3">
                          ...
                          <input value="0" type="number" min="0" name="realisasi_dinas_tw1" id="realisasi_dinas_tw1"
                        ...
                        <div class="mb-3">
                          ...
                          <input value="0" type="number" min="0" name="realisasi_dinas_tw2" id="realisasi_dinas_tw2"
                        ...
                        <div class="mb-3">
                          ...
                          <input value="0" type="number" min="0" name="realisasi_dinas_tw3" id="realisasi_dinas_tw3"
                        ...
                        <div class="mb-3">
                          ...
                          <input value="0" type="number" min="0" name="realisasi_dinas_tw4" id="realisasi_dinas_tw4"
                ...
                <div class="modal-body p-0">
                  <div class="card card-plain">
                    ...
                    <div class="card-body">
                      <form id="ubah_anggaranDinas">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" min="0" name="pagu_dinas" id="ubah_pagu_dinas" class="form-control"
                            placeholder="Pagu Anggaran" aria-label="pagu">
                        </div>
                        <div class="mb-3">
                          <Label>
                          ...
                          <input value="0" type="number" min="0" name="realisasi_dinas_tw1"
                            id="ubah_realisasi_dinas_tw1" class="form-control" placeholder="Realisasi Triwulan 1"
                            aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                          ...
                          <input value="0" type="number" min="0" name="realisasi_dinas_tw2"
                            id="ubah_realisasi_dinas_tw2" class="form-control" placeholder="Realisasi Triwulan 2"
                            aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                          ...
                          <input value="0" type="number" min="0" name="realisasi_dinas_tw3"
                            id="ubah_realisasi_dinas_tw3" class="form-control" placeholder="Realisasi Triwulan 3"
                            aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                          ...
                          <input value="0" type="number" min="0" name="realisasi_dinas_tw4"
                            id="ubah_realisasi_dinas_tw4" class="form-control" placeholder="Realisasi Triwulan 4"
                            aria-label="realisasi_dinas-triwulan">
                        </div>
                      </form>
                    </div>
                    <div class="card-footer">
                      <div class="d-flex align-items-center justify-content-between">
                        <button type="submit" class="btn bg-gradient-success w-25 my-4 mb-2"
                          onclick="js_ubahAnggaranDinas()" data-bs-dismiss="modal">Update</button>
                        <button type="button" class="btn bg-gradient-warning w-25 my-4 mb-2"
