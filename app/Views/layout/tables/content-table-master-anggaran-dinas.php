                    ...
                    <div class="card-body">
                      <form id="simpan_anggaranDinas">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" name="pagu_dinas" id="pagu_dinas" class="form-control" placeholder="Pagu Anggaran" aria-label="pagu">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 1
                          </Label>
                          <input value="0" type="number" name="realisasi_dinas_tw1" id="realisasi_dinas_tw1" class="form-control" placeholder="Realisasi Triwulan 1" aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 2
                          </Label>
                          <input value="0" type="number" name="realisasi_dinas_tw2" id="realisasi_dinas_tw2" class="form-control" placeholder="Realisasi Triwulan 2" aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 3
                          </Label>
                          <input value="0" type="number" name="realisasi_dinas_tw3" id="realisasi_dinas_tw3" class="form-control" placeholder="Realisasi Triwulan 3" aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 4
                          </Label>
                          <input value="0" type="number" name="realisasi_dinas_tw4" id="realisasi_dinas_tw4" class="form-control" placeholder="Realisasi Triwulan 4" aria-label="realisasi_dinas-triwulan">
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="card-body">
                      <form id="ubah_anggaranDinas">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" name="pagu_dinas" id="ubah_pagu_dinas" class="form-control" placeholder="Pagu Anggaran" aria-label="pagu">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 1
                          </Label>
                          <input value="0" type="number" name="realisasi_dinas_tw1" id="ubah_realisasi_dinas_tw1" class="form-control" placeholder="Realisasi Triwulan 1" aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 2
                          </Label>
                          <input value="0" type="number" name="realisasi_dinas_tw2" id="ubah_realisasi_dinas_tw2" class="form-control" placeholder="Realisasi Triwulan 2" aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 3
                          </Label>
                          <input value="0" type="number" name="realisasi_dinas_tw3" id="ubah_realisasi_dinas_tw3" class="form-control" placeholder="Realisasi Triwulan 3" aria-label="realisasi_dinas-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 4
                          </Label>
                          <input value="0" type="number" name="realisasi_dinas_tw4" id="ubah_realisasi_dinas_tw4" class="form-control" placeholder="Realisasi Triwulan 4" aria-label="realisasi_dinas-triwulan">
                        </div>
                      </form>
                    </div>
                    <div class="card-footer">
