                ...
                <div class="modal-body p-0">
                  <div class="card card-plain">
                    <div class="card-header pb-2 pt-5 text-center">
                      <h3 class="font-weight-bolder text-success text-gradient">Ubah Kinerja Dinas
                      </h3>
                      <label>Isi kolom untuk mengubah Kinerja</label>
                    </div>
                    <div class="card-body">
                      <form id="ubah_Kinerja">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" min="0" max="100" name="nilai_pencapaian" id="nilai_pencapaian" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Tahun Pencapaian
                          </Label>
                          <input type="number" min="0" name="tahun_pencapaian" id="tahun_pencapaian" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                      </form>
                    </div>
                    <div class="card-footer">
                      <div class="d-flex align-items-center justify-content-between">
                        <button type="submit" class="btn bg-gradient-success w-25 my-4 mb-2" onclick="js_ubahKinerja()" data-bs-dismiss="modal">Update</button>
