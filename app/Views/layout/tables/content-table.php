    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body px-0 pt-0 pb-2">
                                    <div class="table-responsive p-4">
                                        <table id="tabel_TabelMaster" style="width: 100%"
                                            class="table table-hover table-striped align-items-center mb-">
                                            <thead>
                                                <tr>
                                                    <th width="%">Tahun Anggaran Bidang</th>
                                                    <th width="20%">Triwulan Anggaran Bidang</th>
                                                    <th width="20%">Pagu Anggaran Bidang</th>
                                                    <th width="20%">Realisasi Anggaran Bidang</th>
                            ...
                            <div class="card mb-4">
                                <div class="card-header pb-0">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <button class="btn btn-success" role="button" data-bs-toggle="modal"
                                                data-bs-target="#exampleModalTambah6">Tambah</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-0 pb-2">
                                        ...
                                        <div class="card-body">
                                            <form id="form-simpan">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="tahunAnggaranBaru" class="form-control"
                                                        placeholder="Tahun Anggaran" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                        Triwulan Anggaran Bidang
                                                    </Label>
                                                    <select class="form-select" name="triwulanAnggaranBaru"
                                                        aria-label="Triwulan Anggaran Bidang">
                                                ...
                                                <div class="mb-3">
                                                    <Label>
                                                        Pagu Anggaran Bidang
                                                    </Label>
                                                    <input type="text" name="paguAnggaranBaru" class="form-control"
                                                        placeholder="Pagu Anggaran Bidang" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                        Realisasi Anggaran Bidang
                                                    </Label>
                                                    <input type="text" name="realisasiAnggaranBaru" class="form-control"
                                                        placeholder="Realisasi Anggaran Bidang" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                        Divisi Dinas
                                                    </Label>
                                                    <select class="form-select" name="divisiDinasBaru"
                                                        aria-label="Divisi Dinas">
                                                        <option value="sekre">SEKRETARIAT</option>
                                                        <option value="dalduk" selected>DALDUK</option>
                                                        <option value="kbks">KBKS</option>
                                                        <option value="pm">PM</option>
                                                        <option value="pppa">PPPA</option>
                                                        <option value="uptppa">UPT PPA</option>
                                                    </select>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <button type="submit" class="btn bg-gradient-success w-25 my-4 mb-2"
                                                    onclick="simpan()" data-bs-dismiss="modal">Buat</button>
                                                <button type="button" class="btn bg-gradient-warning w-25 my-4 mb-2"
                                                    onclick="$('#form-simpan')[0].reset();"
                                        ...
                                        <div class="card-body">
                                            <form id="form-simpan">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="indikatorDinas" class="form-control"
                                                        placeholder="Indikator Dinas" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                        Divisi Indikator
                                                    </Label>
                                                    <select class="form-select" name="divisiIndikatorBaru"
                                                        aria-label="Divisi Dinas">
                                                        <option value="sekre">SEKRETARIAT</option>
                                                        <option value="dalduk" selected>DALDUK</option>
                                                        <option value="kbks">KBKS</option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="targetIndikator" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="triwulan1Baru" class="form-control"
                                                        placeholder="0" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                    ...
                                                    <input type="text" name="triwulan2Baru" class="form-control"
                                                        placeholder="0" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                    ...
                                                    <input type="text" name="triwulan3Baru" class="form-control"
                                                        placeholder="0" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                    ...
                                                    <input type="text" name="triwulan4Baru" class="form-control"
                                                        placeholder="0" aria-label="Nama">
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <form id="form-simpan">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="namaPencapaianBaru" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="deskripsiPencapaianBaru"
                                                        class="form-control" placeholder="Deskripsi Pencapaian"
                                                        aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                    ...
                                                    <input type="text" name="nilaiPencapaianBaru" class="form-control"
                                                        placeholder="0" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                    ...
                                                    <input type="text" name="tahunPencapaian" class="form-control"
                                                        placeholder="0" aria-label="Nama">
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <form id="form-simpan">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="namanBaru" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="nipBaru" class="form-control"
                                                        placeholder="NIP" aria-label="Nama">
                                                </div>
                                                <div class="mb-3">
                                                    <Label>
                                                        Jabatan
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="divisiPegawaiBaru"
                                                        aria-label="Divisi Pegawai">
                                                        <option value="sekre">SEKRETARIAT</option>
                                                        <option value="dalduk" selected>DALDUK</option>
                                                        <option value="kbks">KBKS</option>
                                                        <option value="pm">PM</option>
                ...
                <!-- modal simpan / tambah Profil Dinas-->
                <div class="col-md-4">
                                        ...
                                        <div class="card-body">
                                            <form id="form-simpan">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="namaBidangBaru" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="deskripsiBidangBaru" class="form-control"
                ...
                <!-- modal simpan / tambah -->
                <div class="col-md-4">
                    <div class="modal fade" id="exampleModalUbah" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered " role="document">
                            <div class="modal-content">
                                <div class="modal-body p-0">
