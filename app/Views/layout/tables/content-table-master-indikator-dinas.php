                    ...
                    <div class="card-body">
                      <form id="simpan_Indikator">
                        ...
                        <div class="mb-3">
                          ...
                          <select id="divisi_indikator" class="form-select" name="divisi_indikator" aria-label="Divisi Dinas">
                          </select>
                        </div>
                        <div class="mb-3">
                          <Label>
                          ...
                          <input type="number" min="0" name="target_indikator" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 1
                          </Label>
                          <input value="0" type="number" min="0" name="triwulan_1" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 2
                          </Label>
                          <input value="0" type="number" min="0" name="triwulan_2" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 3
                          </Label>
                          <input value="0" type="number" min="0" name="triwulan_3" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 4
                          </Label>
                          <input value="0" type="number" min="0" name="triwulan_4" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="card-body">
                      <form id="ubah_Indikator">
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-select" name="divisi_indikator" aria-label="Divisi Dinas" id="ubah_divisi_indikator">
                          </select>
                        </div>
                        <div class="mb-3">
                          <Label>
                          ...
                          <input type="number" min="0" name="target_indikator" id="target_indikator" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 1
