              ...
              <div class="modal-content">
                <div class="modal-body p-0">
                  <div class="card card-plain">
                    ...
                    <div class="card-footer">
                      <div class="d-flex align-items-center justify-content-between">
                        <button type="submit" class="btn bg-gradient-success w-25 my-4 mb-2" onclick="js_ubahDataBidang()" data-bs-dismiss="modal">Update</button>
                    ...
                    <div class="card-body">
                      <form id="ubah_anggaranBidang">
                        ...
                        <div class="mb-3">
                          ...
                          <input readonly type="number" min="2020" id="ubah_tahun" max="2099" name="tahun" class="form-control" placeholder="Tahun Anggaran" aria-label="Tahun">
                        </div>

                        <input type="hidden" name="id_bidang" id="ubah_id_bidang" class="form-control" placeholder="Pagu Anggaran" aria-label="pagu">
                        <div class="mb-3">
                          <Label>
                            Pagu Bidang
                          </Label>
                          <input readonly type="number" name="pagu_bidang" id="ubah_pagu_bidang" class="form-control" placeholder="Pagu Anggaran" aria-label="pagu">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 1
                          </Label>
                          <input value="0" type="number" min="0" name="realisasi_tw1" id="ubah_realisasi_tw1" class="form-control" placeholder="Realisasi Triwulan 1" aria-label="realisasi-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 2
                          </Label>
                          <input value="0" type="number" min="0" name="realisasi_tw2" id="ubah_realisasi_tw2" class="form-control" placeholder="Realisasi Triwulan 2" aria-label="realisasi-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 3
                          </Label>
                          <input value="0" type="number" min="0" name="realisasi_tw3" id="ubah_realisasi_tw3" class="form-control" placeholder="Realisasi Triwulan 3" aria-label="realisasi-triwulan">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Realisasi Triwulan 4
                          </Label>
                          <input value="0" type="number" min="0" name="realisasi_tw4" id="ubah_realisasi_tw4" class="form-control" placeholder="Realisasi Triwulan 4" aria-label="realisasi-triwulan">
                        </div>
                      </form>
                    </div>
                    <div class="card-footer">
                      <div class="d-flex align-items-center justify-content-between">
                        <button type="submit" class="btn bg-gradient-success w-25 my-4 mb-2" onclick="js_ubahAnggaranBidang()" data-bs-dismiss="modal">Update</button>
                    ...
                    <div class="card-body">
                      <form id="ubah_Indikator">
                        <div class="mb-3">
                          ...
                          <input readonly type="text" name="indikator_dinas" class="form-control" placeholder="Indikator Dinas" aria-label="Nama" id="indikator_dinas">
                        </div>

                        <input type="hidden" class="form-select" name="divisi_indikator" aria-label="Divisi Dinas" id="ubah_divisi_indikator">
                        </input>
                        <div class="mb-3">
                          <Label>
                            Target Indikator
                          </Label>
                          <input readonly type="text" name="target_indikator" id="target_indikator" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 1
                          </Label>
                          <input type="number" min="0" name="triwulan_1" id="triwulan_1" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 2
                          </Label>
                          <input type="number" min="0" name="triwulan_2" id="triwulan_2" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 3
                          </Label>
                          <input type="number" min="0" name="triwulan_3" id="triwulan_3" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                        <div class="mb-3">
                          <Label>
                            Triwulan 4
                          </Label>
                          <input type="number" min="0" name="triwulan_4" id="triwulan_4" class="form-control" placeholder="0" aria-label="Nama">
                        </div>
                      </form>
                    </div>
                    <div class="card-footer">
                      <div class="d-flex align-items-center justify-content-between">
                        <button type="submit" class="btn bg-gradient-success w-25 my-4 mb-2" onclick="js_ubahIndikator()" data-bs-dismiss="modal">Update</button>
