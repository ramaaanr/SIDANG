                ...
                <div class="modal-body">
                    <div class="row featurette">
                        <div class="col-md-5 order-md-2">
                            <form method="POST" action="<?= base_url("login/cek") ?>" autocomplete="off" id="formLogin">
                                <label style="font-size: 12px;"><?= $pesan_ui ?></label>
                                <div class="mb-2">
                                    <label for="validationServerUsername"
                                        class="form-label"><small>Username</small></label>
                                ...
                                <div class="form-floating mb-4">
                                    <select class="form-select" size="1" id="divisi"
                                        aria-label="Floating label select example" required="" name="divisi">
                                        <optgroup>
                                            <option selected="">DALDUK</option>
                                            <option selected="">KB & KS</option>
                                            <option selected="">PM</option>
                                            <option selected="">PPA</option>
