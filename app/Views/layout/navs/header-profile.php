      ...
      <div class="row w-100 d-flex">
        <div class="col-10">
          <div class="d-flex align-items-center">
            <img style="width: 35px;height: 45px;" class="me-1" src="<?= base_url() ?>/assets/img/logo-pemko/logo-pemko.png" alt="">
          ...
          <h6 id="namaBidang" class="font-weight-bolder text-white mb-0"></h6>
        </div>
        <div class="col-2 d-flex justify-content-center align-items-center">
          <img style="width: 75px; height: 75px;" src=" <?= base_url() ?>/assets/img/logo-pemko/logo-bjb-juara.png" alt="">
