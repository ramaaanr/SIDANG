<aside style="background-color: #ffffff;" class="sidenav bg-white d-flex z-index-3 navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main" data-color="dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item" id="nav-tabel-master">
        ...
        <ul class="collapse nav show flex-column ms-1" id="submenu2" data-bs-parent="#menu">
          <li class="w-100">
            <a class="nav-link active " href="<?= base_url() ?>AnggaranBidang">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              </div>
