<aside style="background-color: #ffffff;"
  class="z-index-3 d-flex d-flex sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4"
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?= base_url() ?>BidangPPPA">
              <div
                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              </div>
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?= base_url() ?>BidangPPHA">
              <div
                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              </div>
