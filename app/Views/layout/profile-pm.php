...
<body class="g-sidenav-show bg-gray-100">
  ...
  <?php include('navs/sidenav-profile-pm.php') ?>
  ...
  $(document).ready(function() {
    tabelDataBidang = $('#tabelDataBidang').DataTable({
      "ajax": {
        // json datasource
        url: "<?= base_url(); ?>/DataBidang/dataDataBidangSpec/PEMBERDAYAAN MASYARAKAT",
  ...
  $(document).ready(function() {
    $.ajax({
      method: "POST",
      url: "<?= base_url(); ?>/BidangPM/dataChartBar",
      data: {
        id: bidang
      },
      dataType: "json"
  ...
  $(document).ready(function() {
    $.ajax({
      method: "POST",
      url: "<?= base_url(); ?>/BidangPM/dataBidang",
      data: {
        id: bidang
      },
      dataType: "json"
  ...
  $(document).ready(function() {
    dataPegawaiBidang = $('#tabel_dataPegawaiBidang').DataTable({
      "ajax": {
        // json datasource
        type: "POST", // method  , by default get
        url: "<?= base_url(); ?>/BidangPM/dataPegawaiBidang",
        data: {
          id: bidang
        },
        error: function() { // error handling
  ...
  $(document).ready(function() {
    ...
    dataPegawaiBidang = $('#tabel_dataIndikatorBidang').DataTable({
      "ajax": {
        // json datasource
        type: "POST", // method  , by default get
        url: "<?= base_url(); ?>/BidangPM/dataIndikatorBidang",
        data: {
          id: bidang
        },
        error: function() { // error handling
