...
<body class="g-sidenav-show bg-gray-100">
  ...
  <?php include('navs/sidenav-profile-dalduk.php') ?>
  ...
  <script lang="javascript" type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      tabelDataBidang = $('#tabelDataBidang').DataTable({
        "ajax": {
          // json datasource
          url: "<?= base_url(); ?>/DataBidang/dataDataBidangSpec/4",
    ...
    $(document).ready(function() {
      $.ajax({
        method: "POST",
        url: "<?= base_url(); ?>/BidangDalduk/dataChartBar",
        data: {
          id: bidang
        },
        dataType: "json"
    ...
    $(document).ready(function() {
      $.ajax({
        method: "POST",
        url: "<?= base_url(); ?>/BidangDalduk/dataBidang",
        data: {
          id: bidang
        },
        dataType: "json"
    ...
    $(document).ready(function() {
      $.ajax({
        method: "POST",
        url: "<?= base_url(); ?>/BidangDalduk/dataAnggaran",
        data: {
          id_bidang: bidang,
          tahun: year,
          triwulan: quarterly
    ...
    $(document).ready(function() {
      dataPegawaiBidang = $('#tabel_dataPegawaiBidang').DataTable({
        "ajax": {
          // json datasource
          type: "POST", // method  , by default get
          url: "<?= base_url(); ?>/BidangDalduk/dataPegawaiBidang",
          data: {
            id: bidang
          },
          error: function() { // error handling
    ...
    $(document).ready(function() {
      ...
      dataPegawaiBidang = $('#tabel_dataIndikatorBidang').DataTable({
        "ajax": {
          // json datasource
          type: "POST", // method  , by default get
          url: "<?= base_url(); ?>/BidangDalduk/dataIndikatorBidang",
          data: {
            id: bidang
          },
          error: function() { // error handling
    ...
    //      $.ajax({
    //        method: "POST",
    //        url: "/BidangDalduk/dataPersentaseIndikator",
    //        data: {
    //          id: bidang
    //        },
    //        dataType: "json"
    //      }).done(function(postBagan) {
