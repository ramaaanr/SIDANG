...
<body class="g-sidenav-show bg-gray-100">
  ...
  <?php include('navs/sidenav-profile-sekre.php') ?>
  ...
  $(document).ready(function() {
    tabelDataBidang = $('#tabelDataBidang').DataTable({
      "ajax": {
        // json datasource
        url: "<?= base_url(); ?>/DataBidang/dataDataBidangSpec/SEKRETARIAT",
  ...
  $(document).ready(function() {
    $.ajax({
      method: "POST",
      url: "<?= base_url(); ?>/BidangSEKRE/dataChartBar",
      data: {
        id: bidang
      },
      dataType: "json"
      ...
      if (postChartBar.data.length == 0) {
        // Mengosongkan tabel dan header
        console.info("masuk");
        $('#chart-indikator-body').html(
          '<div class="alert alert-light text-center  font-weight-bold" role=" alert ">Data Indikator Masih Kosong!</div>'
        );
        return;
      }
  ...
  $(document).ready(function() {
    $.ajax({
      method: "POST",
      url: "<?= base_url(); ?>/BidangSEKRE/dataBidang",
      data: {
        id: bidang
      },
      dataType: "json"
  ...
  $(document).ready(function() {
    $.ajax({
      method: "POST",
      url: "<?= base_url(); ?>/BidangSEKRE/dataAnggaran",
      data: {
        id_bidang: bidang,
        tahun: year,
        triwulan: quarterly
  ...
  $(document).ready(function() {
    dataPegawaiBidang = $('#tabel_dataPegawaiBidang').DataTable({
      "ajax": {
        // json datasource
        type: "POST", // method  , by default get
        url: "<?= base_url(); ?>/BidangSekre/dataPegawaiBidang",
        data: {
          id: bidang
        },
        error: function() { // error handling
  ...
  $(document).ready(function() {
    ...
    dataPegawaiBidang = $('#tabel_dataIndikatorBidang').DataTable({
      ...
      "ajax": {
        // json datasource
        type: "POST", // method  , by default get
        url: "<?= base_url(); ?>/BidangSekre/dataIndikatorBidang",
        data: {
          id: bidang
        },
        error: function() { // error handling
    ...
    // Pengecekan jika data kosong
    if (dataPegawaiBidang.data().count() === 0) {
      // Mengosongkan tabel dan header
      $('#tabel-indikator-container').html(
        '<div class="alert alert-light text-center  font-weight-bold" role=" alert ">Data Indikator Masih Kosong!</div>'
      );
    }
  });
