...
<body class="g-sidenav-show bg-gray-100">
  ...
  $(document).ready(function() {
    ...
    tabelDataBidang = $('#tabelDataBidang').DataTable({
      "ajax": {
        // json datasource
        url: "<?= base_url(); ?>/DataBidang/dataDataBidangSpec/5",
      ...
      try {
        ...
        if (postChartBar.data.length == 0) {
          ...
          $('#chart-indikator-body').html(
            '<div class="alert alert-light text-center  font-weight-bold" role=" alert ">Bidang Sekretaris Tidak Memiliki indikator</div>'
          );
          return;
        }
      } catch (error) {
