...
class TabelSaran extends Model
{
    protected $table         = 'komen_dinas';
    protected $primaryKey    = '';
    protected $allowedFields = ['nama', 'komentar', 'skor'];
    protected $column_order  = ['nama', 'komentar', 'skor'];
    protected $column_search = ['nama', 'komentar', 'skor'];
    protected $order         = ['skor' => 'ASC'];
    protected $request;
    protected $db;
    protected $builder;
